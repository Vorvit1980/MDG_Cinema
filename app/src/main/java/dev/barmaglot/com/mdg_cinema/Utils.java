...
public class Utils {
    ...
    public String[] getfilmUrls() {
        String[] filmUrls = {"bjpFWy15Dr8", "MdaqPOPXVSc", "L1PZkSiMcWs", "YJgggIqdXp4",
                "_l0CSTWgstk", "75JjflWKs98", "P-l28qSV5ZY", "7CDR2RPjMZE"};
        return filmUrls;
    }
}
